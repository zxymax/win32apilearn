...
这是一个专为初学者设计的Win32 API编程教程集合，通过5个递进式示例程序，帮助你循序渐进地掌握Windows桌面应用程序开发的核心概念和实践技巧。每个示例都经过精心设计，包含完整的Unicode中文支持，并配有详细的代码解释和学习指南。
...
main.cpp提供了一个便捷的菜单系统，可以帮助你快速编译和运行各个示例：
...
# 编译所有示例
for %i in (0*.cpp) do g++ %i -o %~ni.exe -mwindows
```
...
- **推荐书籍**：《Windows程序设计》（Charles Petzold）
